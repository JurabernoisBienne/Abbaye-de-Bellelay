...
pat: {
    ...
    brief: "Kloster mit Fokus auf Einkehr, Aufnahme von Pilgern und zirkuläre Aktivitäten."
      ...
      disciplines: {
        ...
        architecture: {
          ...
          img: "assets/img/discipline-architecture.jpg",
          paragraphs: [
  "<a href=\"https://jurabernois-bienne.ch/index.php/s/sDVO8UnYC7EDWK2\" target=\"_blank\">Unter diesem Link</a> finden Sie anonymisierte und nicht abschliessende Auszüge aus Studien, deren Hauptgegenstand die Abbaye de Bellelay war. Diese Studien wurden teilweise vor Ort durch Besuche und Feldworkshops durchgeführt.",
   ...
   "EINLEITUNG\nBellelay ist ein seltenes architektonisches Untersuchungsfeld: ein weitläufiges, historisch geschichtetes Bauensemble von hohem denkmalpflegerischem Wert (Kulturgut von nationaler Bedeutung). Das Nebeneinander von Gebäuden und Bauteilen aus unterschiedlichen Epochen, verbunden mit heutigen Anforderungen an Nutzung und Betrieb, macht den Ort zu einem besonderen Anwendungsbeispiel, um ein Ensemble zu analysieren, zu dokumentieren und weiterzuentwickeln, ohne seine Kohärenz oder seinen kulturhistorischen Wert zu beeinträchtigen.",

  "DENKMALPFLEGERISCHER WERT UND SCHUTZSTATUS: LEITLINIEN FÜR EINGRIFFE \nSchutzbestimmungen und denkmalpflegerischer Wert erfordern eine klare Methodik: Diagnose, Materialverträglichkeit, Reversibilität und Lesbarkeit der Eingriffe. Ziel sind präzise, zurückhaltende und begründete zeitgenössische Verändungen, die aktuelle Anforderungen (Sicherheit, Barrierefreiheit, Komfort) berücksichtigen, ohne das Bestehende zu beschädigen oder abzuwerten.",

  "BAUTECHNISCHE ANALYSE: MATERIALIEN UND SCHADENSBILDER \nBellelay ermöglicht eine differenzierte Analyse der Konstruktionen (Mauerwerk, Tragwerke und Dachstühle, Gebäudehülle, Fenster und Türen) sowie ihrer Vulnerabilitäten: Feuchtigkeit, Energiekennwerte, Alterung, Eingriffe und Reparaturen, kritische Detailpunkte. Entscheidend ist, die Befundaufnahme mit robusten, reparierbaren und dauerhaften Projektentscheidungen zu verknüpfen.",
  ...
  "GEMEINSCHAFTSRÄUME: GEMEINSAME NUTZUNG UND GOUVERNANCE\nBellelay stellt eine zentrale Herausforderung für die betriebliche Organisation dar: Gemeinschaftsflächen für eine Vielzahl von Nutzerinnen und Nutzern zu organisieren und Nutzungsregeln räumlich umzusetzen. Öffentliche und private Bereiche, Pufferzonen, Empfang, Lagerrräume, Zirkulationsflächen und Sicherheit müssen eine effiziente und langfristig funktionierende, gemeinsame Nutzung unterstützen.",

  "RAUMPLANUNG UND ÖRTLICHE GEGEBENHEITEN\nNeben den planungsrechtlichen Grundlagen (Zone für öffentliche Nutzungen), ist das Projekt in konkrete räumliche Rahmenbedingungen eingebettet: Erschliessung, Anlieferung, Parkierung, Infrastrukturnetze, Topografie, Landschaft und Nachbarschaft. Diese Achse untersucht die Schnittstelle zwischen Gebäudeensemble und Territorium, um kohärente, zurückhaltende und kontextgerechte Lösungen zu entwickeln.",

  "KREISLAUFWIRTSCHAFT UND ÖKOSYSTEM DES AREALS\nDer Ort bietet einen geeigneten Rahmen für eine globale kreislauforientierte Herangehensweise: Wiederverwendung, selektiver Rückbau, Instandhaltung und lokale Materialkreisläufe, sowie alle wirtschaftlichen Wechselwirkungen im lokalen Umfeld. Aussenräume können zu einem ganzheitlichen Ökosystem beitragen — Freizeit, Produktion, ökologische Bewirtschaftung — im Einklang mit den Nutzungen und der Gouvernance des Ortes.",

  "ZEITGENÖSSISCHE NUTZUNGEN IN VERBINDUNG MIT DEM BESTEHENDEN\nWohnnutzungen, Arbeit, Veranstaltungen und Empfang erfordern Benutzerfreundlichkeit und Normenkonformität (Akustik, Energie, Thermik, Luftqualität, Barrierefreiheit, Brandschutz). In einem denkmalgeschützten Kontext müssen diese Anforderungen mit Feingefühl in das Bestehende integriert werden: minimale Eingriffe, reversible Lösungen und Respekt vor der architektonischen Lesbarkeit.",

  "SCHLUSSFOLGERUNG\nAn Bellelay zu arbeiten bedeutet, Architektur als  Brücke zwischen Vergangenheit und Zukunft zu verstehen: ein komplexes Ensemble lesen, das Wertvolle schützen und seine Transformation für vielfältige und dauerhafte Nutzungen organisieren. Ziel ist es, zurückhaltende, reversible und betriebstaugliche Interventionsszenarien zu entwickeln, welche die Kohärenz des Ortes stärken und zugleich neue Möglichkeiten der Nutzung, gemeinsamen Bewirtschaftung und Erprobung eröffnen."
          ]
        },
        amenagement: {
          title: "Raumplanung",
  ...
  "RÄUMLICHE DIAGNOSE UND EINBETTUNG IN DEN KONTEXT\nErster Schritt ist die sachliche Klärung der Ausgangslage: geltende Nutzungszuweisungen, baulich nutzbare Bereiche, Perimeter und Restriktionen (Denkmalschutz, Umwelt, Landschaft), Kapazitäten der Netzwerke, Bedingungen für Zugang und Sicherheit sowie Nachbarschaftsthemen. Diese Diagnose bildet die Grundlage der Strategie: was kurzfristig aktivierbar ist, was Verfahren erfordert und was für spätere Etappen vorzusehen ist. Ziel ist eine umsetzungsorientierte Lesart von Restriktionen und Handlungsspielräumen.",

  "ANPASSUNG KOMMUNALER VORSCHRIFTEN FÜR ZWISCHEN NUTZUNGEN\nZwischennutzungen (Ateliers, Wohnen, Veranstaltungen, temporäre Belegung) werden häufig durch Regelwerke gebremst, die auf stabile Situationen ausgerichtet sind. Diese Achse entwickelt—in Abstimmung mit der Gemeinde—Mechanismen eines kontrollierten Spielraums: befristete Bewilligungen, zeitlich limitierte Nutzungen, risikobezogene Anforderungen und Kriterien der Reversibilität. Es geht nicht um Umgehung, sondern um ermöglichtes, gesteuertes Experimentieren, um Programme zu testen, reale Bedürfnisse zu konkretisieren und die langfristige Planungen zu alimentieren.",

  "KOMMUNALER RICHTPLAN / MASTERPLAN: VISION, ETAPPIERUNG UND KOHÄRENZ\nDie Transformation von Bellelay benötigt einen klar lesbaren strategischen Rahmen, der Vision, Gouvernance und Etappierung ausrichtet. Ein kommunaler Richtplan (Masterplan) klärt die Leitlinien: Bestimmung des Gesamtperimeters, Intensitäten und Nutzungskompatibilitäten, Prinzipien der Erhaltung, Organisation der Gemeinschaftsflächen, Umgang mit Aussenräumen sowie die Einbindung in die Infrastruktur. Das Dokument muss eine realistische Etappierung enthalten (was rasch möglich ist vs. was lange Vorläufe hat) und als gemeinsame Referenz für Behörden, Betreiber und Nutzende dienen.",

  "ÜBERBAUORDNUNGSORDNUNG IM EINKLANG MIT DER ZUKÜNFTIGEN ENTWICKLUNG\nÜber die Vision hinaus ist eine Überbauungsordnung (oder ein gleichwertiges Instrument) erforderlich, um die Entwicklung rechtlich zu sichern: Regeln zur Bestimmung und Nutzung, Interventionsperimeter, Bedingungen für Umbau und Umnutzung, Erschliessung, Parkierung, mögliche Nutzungen sowie Qualitätsanforderungen (Landschaft, gemeinschaftliche Räume, denkmalpflegerische Einbindung). Ziel ist eine reglementarische Grundlage, die der Realität des Areals entspricht: Anpassungen und Nutzungsänderungen ermöglichen und zugleich Leitplanken für Gesamtqualität und Kompatibilität für eine Vielzahl von Nutzungen und Nutzenden setzen.",

  "REGIONALE UND KANTONALE POLITISCHE HERAUSFORDERUNGEN BEI UMNUTZUNGEN\nUmnutzungen in dieser Grössenordnung sind nicht nur lokale Entscheidungen: Sie berühren regionale und kantonale Zielsetzungen zu Raumentwicklung, Landschaftsschutz, Denkmalpflege, Wirtschaft und sozialem Zusammenhalt. Diese Achse adressiert die politisch-institutionelle Dimension: ein gemeinsames Narrativ, Stakeholder-Management, Antizipation von Verfahren und Abwägungen sowie die Ausrichtung an übergeordneten Strategien (kantonale Konzepte, sektoriale Politiken). Ziel ist ein Projekt, das öffentlich nachvollziehbar und in den übergeordneten Rahmen plausibel integrierbar ist.",

  "ABSTIMMUNG MIT DER REGIONALEN MOBILITÄTSPLANUNG\nMobilität ist ein Schlüsselfaktor für die Entwicklungsfähigkeit des Standortes: Sie beeinflusst Erreichbarkeit, Akzeptanz und Umweltwirkungen. Diese Achse zielt auf eine enge Koordination mit der regionalen Planung: Stärkung des öffentlichen Verkehrs (Takt, Haltestellen, Anschlüsse), Hierarchisierung der Zufahrten sowie eine phasen- und spitzenorientierte Parkierungssteuerung. Ziel ist, die Abhängigkeit vom Individualverkehr zu reduzieren und gleichzeitig eine inklusive und bedürfnisgerechte Erreichbarkeit zu gewährleisten.",

  "LANGSAMVEKEHR: KONTINUITÄT, SICHERHEIT UND QUALITÄT DER WEGE\nErgänzend zum ÖV ist die Vernetzung der aktiven Mobilität ein eigenständiges Projektthema: sichere Fuss- und Veloverbindungen, klare Routenführung, Querungssicherheit, Veloabstellanlagen sowie die Abstimmung mit betrieblichen Zufahrten. Ebenso geht es um Nutzungsqualität: Ankunfts- und Wegsequenzen sollen als Teil der Ortserfahrung funktionieren und zugleich im alltagstauglich und betriebssicher sein.",

  "UMSETZUNG: GOUVERNANCE, INSTRUMENTE UND LANGFRISTIGES MONITORING\nWirksame Planung braucht klare Instrumente und Zuständigkeiten: Verfahrensfahrplan, Rollenverteilung (Eigentümer, Betreiber, Gemeinde, Kanton, Partner), Partizipationsformate und Monitoring (Mobilität, Immissionen, Nutzungen, Wirkungen). Ziel ist ein lebendiger Planungsprozess, der Rückmeldungen integriert, Regeln bei Bedarf nachschärft und die Entwicklung steuert, ohne die Gesamtlogik des Areals zu verlieren.",

  "SCHLUSSFOLGERUNG\nDie Raumplanung für Bellelay muss Experiment und Absicherung verbinden: Zwischennutzungen ermöglichen, um das Areal zu aktivieren und zu testen, und zugleich einen langfristigen Rahmen über ein kommunales Richtprojekt und eine Überbauungsordnung schaffen, der die künftige Entwicklung trägt. Der Erfolg hängt von politischer und institutioneller Verankerung sowie der Abstimmung mit der regionalen Mobilitätsplanung ab—insbesondere mit dem öffentlichen Verkehr und der aktiven Mobilität. Ziel ist eine glaubwürdige, schrittweise und breit getragene Transformationsstrategie, die den denkmalpflegerischen, räumlichen und gesellschaftlichen Anforderungen des Ortes entspricht."
]
        },
        histoire: {
          title: "Geschichte",
